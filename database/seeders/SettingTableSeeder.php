...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Customer::Create([
            ...
            'email' => 'customer@creativ356.com',
            'phone' => '123456789',
            'country' => 'United States',
            'city' => 'Florida',
            'address' => '864 Pleasant Hill Road , Fort Pierce',
        ]);
        Warehouse::create([
            'name' => 'warehouse',
            'phone' => '123456789',
            'country' => 'United States',
            'city' => 'Florida',
            'email' => 'warehouse1@creativ356.com',
            'zip_code' => '12345',
        ]);
        ...
        $logoUrl = ('images/shopshepherdpro-logo.png');
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'support@creativ356.com']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'Creativ356']);
        }
        ...
        if (! keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'creativ356']);
        }

        if (! keyExist('footer')) {
            Setting::create([
                'key' => 'footer', 'value' => '2022 Developed by Creativ356 All rights reserved - v1.1.0',
            ]);
        }
        ...
        if (! keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => '864 Pleasant Hill Road, Fort Pierce, FL 34950',
            ]);
        }
